          ...
          <View style={{ marginBottom: 20 }}>
            <ButtonContainer>
              <ButtonWrapper>
                <SelectButton
                  ...
                  checked={detailType === PERSON ? true : false}
                >
                ...
                <SelectButton
                  ...
                  checked={detailType === COMPANY ? true : false}
                >
              ...
              <Selected
                color={
                  detailType !== "" ? theme.btnPointColor : theme.textBoxColor
                }
              >
                <Ionicons
            ...
            <LicenseContainer>
              ...
              <PlainButton
                text="촬영"
                onPress={takePicture}
                style={{ width: "23%", marginBottom: 7, height: 46 }}
              />
            </LicenseContainer>
            <ColumnInputItem title="차량번호">
              <TextInput
                ...
                returnKeyType="done"
                onChangeText={(text) => setValue("vehicleNumber", text)}
              />
            </ColumnInputItem>
            {detailType === PERSON ? (
              // TODO: 추후 수정 (필수입력도 수정)
              <PickerContainer>
                <Picker //TODO: Picker style
                  ref={pickerRef}
                  selectedValue={test1}
                  onValueChange={(itemValue, itemIndex) => setTest1(itemValue)}
                  style={{ width: "49%" }}
                >
                ...
                <Picker //TODO: Picker style
                  ref={pickerRef}
                  selectedValue={test2}
                  onValueChange={(itemValue, itemIndex) => setTest2(itemValue)}
                  style={{ width: "49%" }}
                >

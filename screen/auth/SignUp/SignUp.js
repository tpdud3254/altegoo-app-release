  ...
  return (
    <Container>
      <Wrapper onPress={() => onPress(ORDINARY)}>
        <Title>
          <PlainText style={{ fontWeight: "400" }}>일반 회원가입</PlainText>
          <Entypo name="chevron-small-right" size={30} color={color.main} />
        </Title>
      ...
      <Wrapper onPress={() => onPress(SPECIAL, PERSON)}>
        <Title>
          <PlainText style={{ fontWeight: "400" }}>기사 회원가입</PlainText>
          <Entypo name="chevron-small-right" size={30} color={color.main} />
        </Title>
        <HorizontalDivider thickness={0.5} color={color.lightGrey} />
        <Content>
      ...
      <Wrapper onPress={() => onPress(SPECIAL, COMPANY)}>
        <Title>
          <PlainText style={{ fontWeight: "400" }}>기업 회원가입</PlainText>
          <Entypo name="chevron-small-right" size={30} color={color.main} />
        </Title>
        <HorizontalDivider thickness={0.5} color={color.lightGrey} />
        <Content>

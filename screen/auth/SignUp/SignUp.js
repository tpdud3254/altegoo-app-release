      ...
      <Container>
        <Wrapper>
          <Button onPress={() => onPress(ORDINARY)}>
            <SubTitleText style={{ color: theme.lightFontColor, fontSize: 25 }}>
              일반회원 가입
            </SubTitleText>
          </Button>
          <Content>
            <PlainText style={{ fontSize: 20 }}>
              일반회원은 작업 등록만 가능하며 등록된 작업을 예약할 수 없습니다.
              {"\n"}일반회원 가입 후 언제든지 자유롭게 기사/기업회원 전환이
              가능합니다.
            </PlainText>
          </Content>
        </Wrapper>
        <Wrapper>
          ...
          <Content>
            <PlainText style={{ fontSize: 20 }}>
              기사/기업회원은 작업 등록 분만 아니라 등록된 작업을 예약하여
              진행하실 수 있습니다.{"\n"}제휴 기업의 경우 별도의 작업 등록
              시스템이 제공됩니다.
            </PlainText>
          </Content>

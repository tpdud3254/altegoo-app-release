  ...
  const uploadLicense = (fileName) => {
    ...
    axios
      ...
      .then(({ data }) => {
        ...
        if (result === VALID) {
          if (info.vehiclePermission && info.vehiclePermission !== "") {
            uploadVehiclePermission(info.vehiclePermission, location);
          } else {
            ...
            <Wrapper>
              <Terms>
                ...
                <Checkbox
                  ...
                  color={isAllChecked ? color.main : undefined}
                />
              </Terms>
              {termsTexts.map((text, index) => (
                <Terms key={index}>
                  ...
                  <Checkbox
                    ...
                    color={checkArr[index] ? color.lightGrey : undefined}
                  />
                </Terms>
              ))}
            </Wrapper>

          ...
          {order.orderStatusId === 1 ? (
            <Container>
              <Wrapper center>
                <Center>
                  <View style={{ marginLeft: -27 }}>
                    <Row>
                      <Entypo name="check" size={27} color={color.sub.blue} />
                      <SubTitleText>요청 완료</SubTitleText>
                    </Row>
                  </View>
                  <CancleButton onPress={() => CancleOrder(order.id)}>
              ...
              <Wrapper>
                <TextRow>
                  ...
                  <PlainText style={{ color: "#777" }}>
                    {getWorkTime(order.workDateTime, "short")}
                  </PlainText>
                </TextRow>
                {order.type === "양사" ? (
                  <>
                  ...
                  <TextRow>
                    <PlainText style={{ width: "25%" }}>작업 주소</PlainText>
                    <PlainText
                      numberOfLines={1}
                      style={{
                        width: "80%",
              ...
              <Wrapper>
                ...
                >
                  <TextRow>
                    ...
                    <PlainText>{order.vehicleType}</PlainText>
                  </TextRow>
                  <TextRow>
                  ...
                  {order.quantity ? (
                    <TextRow>
                      ...
                      <PlainText>{order.quantity}</PlainText>
                    </TextRow>
                  ) : (
                    <TextRow>
                      <PlainText>작업 시간</PlainText>
              ...
              <Wrapper>
                ...
                >
                  <TextRow>
                    ...
                    <PlainText>{order.registUser.userName}</PlainText>
                  </TextRow>
                  <TextRow>
                  ...
                  <TextRow>
                    ...
                    <PlainText>{order.directPhone}</PlainText>
                  </TextRow>
                </View>
              </Wrapper>
              ...
              <Wrapper>
                <TextRow>
                  ...
                  <PlainText>{numberWithComma(order.price)} AP</PlainText>
                </TextRow>
              </Wrapper>
              <Divider />
              <Wrapper>
                <TextRow>
                  <PlainText style={{ color: "#ef5285" }}>쿠폰 할인</PlainText>
                  <PlainText style={{ color: "#ef5285" }}>
                    {numberWithComma(20000)} AP
                  </PlainText>
                </TextRow>
                <TextRow>
                  <PlainText style={{ color: color.sub.green }}>
                    총 필요 AP
                  </PlainText>
                  <PlainText style={{ color: color.sub.green }}>
                    {numberWithComma(order.price - 20000)} AP
                  </PlainText>
                </TextRow>
              </Wrapper>
              <Divider />
              <Wrapper>
                <TextRow>
                  ...
                  <SubTitleText style={{ color: color.main }}>
                    {numberWithComma(
                      order.price - 20000 + (order.price - 20000) * 0.1
                    )}{" "}
                    AP
                  </SubTitleText>
                </TextRow>
            ...
            <Container>
              <ProgressBar>
                ...
                <Bar />
                <Indicator
                  cur={order.orderStatusId === 4 || order.orderStatusId === 5}
                />
              </ProgressBar>
              <TextProgressBar>
              ...
              <View>
                ...
                <View>
                  <View style={{ flexDirection: "row" }}>
                    <PlainText style={{ marginRight: 10 }}>작업비용</PlainText>
                  ...
                  <View style={{ flexDirection: "row" }}>
                    <PlainText style={{ marginRight: 10 }}>작업AP</PlainText>
                    <PlainText style={{ fontWeight: "500" }}>
                ...
                <View>
                  ...
                  <View style={{ flexDirection: "row" }}>
                    ...
                    <PlainText style={{}}>{order.phone}</PlainText>
                  </View>
                  <View style={{ flexDirection: "row" }}>
                    <PlainText
                      style={{
                    ...
                    <PlainText style={{}}>{order.memo || "없음"}</PlainText>
                  </View>
                </View>
                <View style={{ marginTop: 20, marginBottom: 20 }}>
                  <HorizontalDivider />
                ...
                <View>
                  ...
                  <View style={{ flexDirection: "row" }}>
                    ...
                    <PlainText style={{}}>{user?.userName} 기사님</PlainText>
                  </View>
                  <View style={{ flexDirection: "row" }}>
                    <PlainText
                      style={{
                    ...
                    <PlainText style={{}}>{user?.phone}</PlainText>
                  </View>
                  {user?.vehicle ? (
                    user?.vehicle?.length > 0 ? (
                      <>
                        ...
                        >
                          ...
                          <PlainText style={{}}>123가 1234</PlainText>
                        </View>
                        <View
                          style={{
                            flexDirection: "row",
                        ...
                        >
                          ...
                          <PlainText style={{}}>3ton</PlainText>
                        </View>
                      </>
                    ) : null
                  ) : null}

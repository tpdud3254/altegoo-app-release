...
function Home({ navigation }) {
  ...
  const AcceptButton = ({ orderId }) => (
    ...
    >
      <PlainText style={{ fontSize: 19, color: "white" }}>예약하기</PlainText>
    </OrderButton>
  );
  ...
  const ReserveButton = ({ orderId }) => (
    ...
    >
      <PlainText style={{ fontSize: 19, color: "white" }}>예약대기</PlainText>
    </OrderButton>
  );

  const CancleButton = () => (
    <OrderButton color="#777">
      <PlainText style={{ fontSize: 19, color: "white" }}>예약취소</PlainText>
    </OrderButton>
  );
                ...
                <View>
                  ...
                  <FilterContaier>
                    <FilterWrapper>
                      <Menu
                        ...
                        anchor={
                          <Filter onPress={openRegionFilter}>
                      ...
                      >
                        <Menu.Item
                          onPress={() => filterOrderList("region", "my")}
                          title="내 작업 지역"
                          style={{ backgroundColor: "white" }}
                        />
                        <Divider />
                        <Menu.Item
                          onPress={() => filterOrderList("region", "all")}
                          title="모든 작업 지역"
                          style={{ backgroundColor: "white" }}
                        />
                      </Menu>
                    ...
                    <FilterWrapper>
                      <Menu
                        ...
                        anchor={
                          <Filter onPress={openStatusFilter}>
                      ...
                      >
                        <Menu.Item
                          onPress={() =>
                            filterOrderList("status", "inProgress")
                          }
                          title="요청 중 작업"
                          style={{ backgroundColor: "white" }}
                        />
                        <Divider />
                        <Menu.Item
                          onPress={() => filterOrderList("status", "all")}
                          title="모든 작업"
                          style={{ backgroundColor: "white" }}
                        />
                      </Menu>
                  ...
                  <Orders>
                    {orderList.map((order, index) => (
                      <Order key={index} disabled={order.orderStatusId === 4}>
                        <Status status={order.orderStatusId}>
                          <PlainText
                            style={{
                              color:
                                statusArr[order.orderStatusId - 1].textColor,
                              fontSize: 18,
                            }}
                          >
                            {statusArr[order.orderStatusId - 1].text}
                          </PlainText>
                        </Status>
                        <OrderWrapper>
                          <OrderContent>
                            ...
                            <PlainText
                              style={{ marginLeft: 5, fontSize: 19 }}
                              numberOfLines={1}
                            >
                          ...
                          <OrderContent>
                            ...
                            <PlainText
                              ...
                              numberOfLines={1}
                            >
                              {numberWithComma(order.price)}AP / 수수료 :{" "}
                              {numberWithComma(order.point)}AP
                            </PlainText>
                          </OrderContent>
                        </OrderWrapper>
                        <OrderButtonContainer>
                          {order.orderStatusId === 1 ? (
                            ...
                            order.acceptUser === info.id ? (
                              ...
                              <ReserveButton orderId={order.id} />
                            )
                          ) : null}
                        </OrderButtonContainer>
                      </Order>
